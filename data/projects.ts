...
export const projects: Project[] = [
  {
    ...
    coverAlt: "Stride cover: the app's welcome screen mockup next to the STRIDE wordmark, labeled \"Personal project 360\"",
    ...
    caseStudyBlocks: [
      {
        ...
        watermark: { src: "/projects/stride/logo-full.png", alt: "Stride logo" },
        deviceFrame: true,
        meta: [],
